class Engine
    ...
    def play()
        ...
        last_scene = @scene_map.get_scene(:finished)
...
class LaserWeaponArmory < Scene
    def enter()
        ...
        if guess == code
            ...
            puts "You grab the neutrom bomb and run as fast as you can to the"
...
class Map
    # @: Instance variable. A regular class variable, with a class-wide scope
    # @@: class variable, also known as a STATIC variable
    # so its value is shared between all instances of a class
    @@scenes = {
